...
public class InvalidLoginTest {
	...
	public void invalidLoginTest() {
		...
		obj.clickLogin();
		Assert.assertTrue(obj.isErrorMessageVisible(Constants.ERROR_MSG), "Error message in not visible - test failed");
	}
